  ...
  return (
    <div className="min-h-screen w-full bg-black flex items-center justify-center p-8">
      <div className="w-full max-w-2xl bg-zinc-950 border border-zinc-800 rounded-2xl p-8">
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-white">Cadastrar Plano</h1>

          <p className="text-zinc-400 mt-2">Preencha os dados do novo plano</p>
        </div>
        ...
        <form className="space-y-5">
          ...
          <div>
            <label className="text-zinc-300">Duração em meses</label>
